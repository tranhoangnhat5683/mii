...
{
    if (!StringHelper['Helper_Array'])
    {
        StringHelper['Helper_Array'] = require('./Array');
    }

    return StringHelper['Helper_Array'];
}
;

function regexHelper()
{
    if (!StringHelper['Helper_Regex'])
    {
        StringHelper['Helper_Regex'] = require('./Regex');
    }

    return StringHelper['Helper_Regex'];
}
;
...
StringHelper.detectLanguage = function(text, format)
{
    if (!format)
    {
        format = 'iso2';
